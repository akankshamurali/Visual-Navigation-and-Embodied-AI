...
class KeyboardPlayer(Player):
    def __init__(self):
        ...
        self.maze_img=cv2.imread('maze_solver/Maze2_Manual.jpg',cv2.IMREAD_GRAYSCALE)
        self.FEATURES_PATH = "maze2features_joblib/image_features.joblib"
        self.PATHS_PATH = "maze2features_joblib/image_paths.joblib"
        self.image_location = "clean_images_final_maze2/"
        self.auto=False
        ...
        self.chk_col=None
        self.hit_wal=False
        self.maze_cood_file = "maze2_img_cood.json"
